...
let password = 'penglifa';  // 主页密码,建议修改或添加 PASSWORD环境变量
let proxyIP = 'proxy.xxxxxxxx.tk:50001';  // proxyIP 格式：ip、域名、ip:port、域名:port等,没填写port，默认使用443
let yourUUID = '87a8ecf7-4d8f-4c6c-9dd0-86c088459176'; // UUID,建议修改或添加环境便量
    ...
    <div class="container">
        ...
        <div class="footer">
            <div class="footer-links">
                <a href="https://yongyou.blogspot.com/" target="_blank" class="footer-link">
